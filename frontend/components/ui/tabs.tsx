...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center gap-1 rounded-lg border border-border bg-card p-1 text-muted-foreground overflow-x-auto scrollbar-thin max-w-full",
      className,
    )}
    {...props}
  />
